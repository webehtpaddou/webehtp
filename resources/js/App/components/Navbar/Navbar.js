...
class Navbar extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            a href = "/"
            className = "nav-item nav-link active" > Accueil < /a> <
            Link to = "/produits"
            className = "nav-item nav-link" > Produits < /Link> <
            a href = "cart.html"
            className = "nav-item nav-link" > Panier < /a> < /
            div > {
                ...
                data - toggle = "dropdown" > { this.state.user_name } < /a> <
                ...
                a href = "/logout"
                onClick = { this.logout }
                className = "dropdown-item" > Se deconnecter < /a> < /
                div > <
                /div> < /
                div > :
                    <
                ...
                id = "user"
                className = "nav-link dropdown-toggle"
                data - toggle = "dropdown" > Espace client < /a> <
                div className = "dropdown-menu" >
                <
                Link to = "/authentification"
                className = "dropdown-item" > S 'authentifier</Link> < /
                div > <
                /div> < /
                div >
            }
            ...
            a href = "/" >
            <
            img src = "https://imgupload.io/images/2020/12/29/logof5f41476f46b637e.png"
